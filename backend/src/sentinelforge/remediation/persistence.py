...
_VALID_TRANSITIONS = {
    ...
    "TESTING": {"RETESTING", "VERIFIED", "FAILED", "ROLLED_BACK", "REQUIRES_HUMAN_REVIEW"},
    "RETESTING": {"VERIFIED", "FAILED", "ROLLED_BACK", "REQUIRES_HUMAN_REVIEW"},
    "FAILED": set(),
    "ROLLED_BACK": {"PROPOSED", "APPLIED", "TESTING"},
    "VERIFIED": set(),
